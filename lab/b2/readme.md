...
Blast the genes that you found in the **previous bioinformatics lab** (think about which file to use: not the input files, but the output from labB1) against the reference genome of the bacteria that you chose (reference genomes provided in this lab). Remember to choose a suitable E-value for your search.
